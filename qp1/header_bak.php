...
<script type="text/javascript" language="javascript" src="dt/media/js/jquery.dataTables.min.js">
	</script>
<script type="text/javascript" language="javascript" src="dt/media/js/dataTables.bootstrap.js">
	</script>
	...
	<link rel="stylesheet" type="text/css" href="dt/media/css/dataTables.bootstrap.css">
    ...
    <body>
        <div class="main-wrapper">
            <div class="app" id="app">
				...
				<li>
                                    <a href="admin4.php"> <i class="fa fa-th-large"></i> Extra Analytics<i class="fa arrow"></i> </a>
