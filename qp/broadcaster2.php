...
<div id="content" role="main" style="min-height:500px;margin: 2% 5%;">
		<center><h2>HOME</h2><h3>ACTIVE LIVE/TIME BROADCASTER</h3></center><br>
<?php
...
$condition=" AND (end_datetime between '".$datehrbck."' and '".$datenow."') AND page_id=".$channelID.""	;
$conditionA=" AND (a.end_datetime between '".$datehrbck."' and '".$datenow."') AND a.page_id=".$channelID.""	;
$wherecond=" where (end_datetime between '".$datehrbck."' and '".$datenow."') AND page_id=".$channelID.""	;	
...
$durationsdata .= '{date:"'.$r6["user_name"].'",value:"'.$durationAll.'"},';	
echo "<tr>";
...
echo '<div id="durationschart" ></div>
			';
if(count($res6) > 0){ 
    ...
    return ['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov', 'Dec'][d.getMonth()] + ' ' + d.getDate();
		...
		<?php
		} else { echo "<script>document.getElementById('durationschart').innerHTML = 'No analytics found';</script>"; } 
