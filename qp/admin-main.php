...
$tz=get_var("SELECT timezone from visitors_info where user_id=$user_id order by id desc limit 1");
			$user_time = new DateTimeZone("+05:30");
			$datetime->setTimezone($user_time);
			echo $user_time=$datetime->format('D h:i A T') ;*/
