...
<link rel="stylesheet" href="css/jquery-ui.css">
	...
	<div id="content" role="main" style="min-height:500px;margin: 2% 5%;">
		<center><h2>HOME</h2><h3>ACTIVE LIVE/TIME ADMIN</h3></center><br>
...
$conditionA=" AND (a.end_datetime between '".$datehrbck."' and '".$datenow."')"	;
...
$sql12="select user_name,page_name,end_datetime,sum(duration) as duration,count(*) as hits from visitors_info where user_id>0 AND (end_datetime between '2016-09-26 13:07:27' and '2016-09-26 14:07:27') group by end_datetime";
$stmt12 = $dbcon->prepare($sql12, array(PDO::ATTR_CURSOR => PDO::CURSOR_SCROLL));
$stmt12->execute();
$res12=$stmt12->fetchAll(PDO::FETCH_ASSOC);
$durations=$res12;
...
if(count($durations) > 0){ 
			...
			foreach($durations as $duration){
				...
				$durationsdata .= '{device:"'.$duration["end_datetime"].'",value:"'.$playedduration.'"},';		
			}
