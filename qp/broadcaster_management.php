...
?>
		...
		<div id="search_channel" align="center" style="margin:15px auto;">
		Search channel: <br /> <input placeholder="Enter channel name" id="searchCN" type="text" name="searchCN" /> <span class="_or"> </span>   
