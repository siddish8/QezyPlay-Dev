...
<form>
		<table class="widefat membership-levels" style="width:100% !important;max-width:100% !important;">
			...
			echo 	'<tr id="C-'.$id.'" style="" class="ui-sortable-handle">			
				<td style="width: 50px;" ><img id="gr_imgC-'.$id.'" src="'.SITE_URL.'/qp/images/green_tick.png" style="display:none;width:30px;"/></td>			
				...
				<td style="width: 350px;"><a class="" style="cursor: pointer;color:#2a85e8 !important" id="readContact-'.$id.'" href="user_forms.php?readC=true&id='.$id.'" title="read" name="Read-'.$id.'" class="button-primary"><img src="'.SITE_URL.'/qp/images/book2.jpg" width="50px" title="Read"></a>				<a title="Reply" href="mailto:'.$email.'?subject=QezyPlay%20Contact%20Reply&amp;">
<img src="'.SITE_URL.'/qp/images/email-logo.png" width="50px" title="Reply"></a>
				<a class="" style="cursor: pointer;color:#2a85e8 !important;" title="delete" name="removeContact-'.$id.'" id="removeContact-'.$id.'" onclick="callConfirmationC(\'user_forms.php?delC=true&id='.$id.'\');" class="button-secondary"><img src="'.SITE_URL.'/qp/images/remove.jpg" width="37px" title="Remove"></a></td>
				</tr>';
			 } 
	...
	<div class="clear"></div>
		...
		<table class="widefat membership-levels" style="width:100% !important;max-width:100% !important;">
			...
			echo 	'<tr id="F-'.$id.'" style="" class="ui-sortable-handle">			
				<td style="width: 50px;" ><img id="gr_imgF-'.$id.'" src="'.SITE_URL.'/qp/images/green_tick.png" style="display:none;width:30px;"/></td>			
