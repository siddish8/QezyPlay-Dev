...
<a href="mailto:contact@qezymedia.com">Email us</a>
</div>
</div>
...
<p>+91-910 002 9200</p>
    ...
    <footer class="dark-div">
			...
			<li class="page_item page-item-74"><a href="http://ideabytestraining.com/newqezyplay/about-us/">About Us</a></li>
		</ul>
		</div><div id="pages-4" class=" 1 widget col-md-3 col-sm-6 widget_pages"><h2 class="widget-title maincolor1">Legal</h2>		<ul>
			<li class="page_item page-item-80"><a href="http://ideabytestraining.com/newqezyplay/privacy-policy/">Privacy Policy</a></li>
<li class="page_item page-item-76"><a href="http://ideabytestraining.com/newqezyplay/terms-of-service/">Terms of Service</a></li>
		</ul>
			...
			<li class="page_item page-item-141"><a href="http://ideabytestraining.com/newqezyplay/contact-us/">Contact Us</a></li>
<li class="page_item page-item-153"><a href="http://ideabytestraining.com/newqezyplay/feedback-form/">Feedback Form</a></li>
		</ul>
		</div>                    
                </div><!--/row-->
            </div><!--/container-->
