...
<form id="pmpro_form" class="pmpro_form" action="<?php if(!empty($_REQUEST['review'])) echo pmpro_url("checkout", "?level=" . $pmpro_level->id); ?>" method="post">
	...
	<?php if($pmpro_review) { ?>
		<p><?php _e('Almost done. Review the subscription information and pricing below then <strong>click the "Complete Payment" button</strong> to finish your order.', 'pmpro');?></p>
	<?php } ?>
...
{
echo '<div align="center" style="width:50%;margin:0 auto !important">Your Free Trail already done. Please select <a style="color:blue !important;" href="'.site_url('subscription/').'">Another Plan</a></div>';
