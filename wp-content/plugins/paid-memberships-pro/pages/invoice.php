...
<nav id="nav-below" class="navigation" role="navigation">
	 <div class="nav-next align">
		<a style="background: rgb(1, 6, 1) none repeat scroll 0% 0% !important;
padding: 3px;
border-radius: 5px;" href="<?php echo pmpro_url("account")?>"><?php _e('View Your Subscription Account &rarr;', 'pmpro');?></a>
	</div>
