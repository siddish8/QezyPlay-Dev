		...
		$delay_from_support=$wpdb->get_var("select delay from pmpro_dates_chk1 where user_id=".$this_user." order by id desc limit 1");
			...
			//end
					...
					if ( pmpro_isLevelTrial( $pmpro_level ) ) {
						...
						$txt.="PaymentAmount:".$morder->PaymentAmount."--profile start date--".$morder->ProfileStartDate."--bill period--".$morder->BillingPeriod."--bill freq--".$morder->BillingFrequency;
