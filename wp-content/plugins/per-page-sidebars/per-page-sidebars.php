...
/*	Copyright 2015 DIGITAL SOLUTIONS ( email : plugins@digitalspally.com )
...
function pps_save_postdata( $post_id ) {
	...
	if ( ( current_user_can( 'edit_theme_options' ) ) && 
		...
		// Only save on posts/pages if you have the correct rights. Otherwise just return the id without taking an action.
		return $post_id;
	}
