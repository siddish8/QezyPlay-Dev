...
$args = array( 'vidurl' => $channel_atts['vidurl'], 'vodurl' => $channel_atts['vodurl'],'vodturl' => $channel_atts['vodturl'] );

$vidurl="octoshape://streams.octoshape.net/ideabytes/live/ib-ch";
$vodurl="octoshape://streams.octoshape.net/ideabytes/vod/QP/ib-ch";
$vodturl="octoshape://streams.octoshape.net/ideabytes/vod/QP/";

//$vidurl.="51/auto";				//Change this
$vidurl.=$channel_atts['vidurl'];

if($channel_atts['vodurl']=="")
$vodurl.='0.mp4';
else
$vodurl.=$channel_atts['vodurl'];

if($channel_atts['vodturl']=="")
$vodturl.='ib-ch0.mp4';
else
$vodturl.=$channel_atts['vodturl'];
...
displayVideo($vidurl,$imgurl,$session_id,$post_id,$ip_address,$user_agent,$page_ref,$post_title,$post_name,$page_url,$country_code,$country_name,$state,$city,$geoinfo_status,$octo_js,$vodurl,$vodturl);
