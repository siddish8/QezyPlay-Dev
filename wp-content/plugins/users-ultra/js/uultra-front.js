	   ...
	   "use strict";
		...
		jQuery(document).on("click", "#xoouserultra-forgot-pass-btn-confirm", function(e) {		
			...
			e.preventDefault();			
				...
				var em=document.getElementById("user_name_email");
				if(email!="") //added: if empty no ajax call; 
				{
				...
				{
					em.style.border="1px solid rgb(210, 8, 8) !important";
				em.style.boxShadow="0px 0px 10px rgb(210, 8, 8) !important";
				em.style.outline="medium none";
				}
