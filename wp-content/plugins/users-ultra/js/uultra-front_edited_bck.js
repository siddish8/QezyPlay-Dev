	   ...
	   "use strict";
		...
		jQuery(document).on("click", "#xoouserultra-forgot-pass-btn-confirm", function(e) {		
			...
			/* e.preventDefault();			
				...
				if(email=="")
				{
				document.getElementById("user_name_email").style.border="1px solid rgb(210, 8, 8)";
				document.getElementById("user_name_email").style.boxShadow="0px 0px 10px rgb(210, 8, 8)";
				document.getElementById("user_name_email").style.outline="medium none";	
				return false;
				e.preventDefault();			
				} */
