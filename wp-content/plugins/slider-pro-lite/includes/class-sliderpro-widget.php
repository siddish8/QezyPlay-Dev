 ...
 * @since 1.0.0
 */
class BQW_SliderPro_Lite_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_opts = array(
			'classname' => 'bqw-sliderpro-lite-widget',
			'description' => 'Display a Slider Pro instance in the widgets area.'
		);
		
		parent::__construct( 'bqw-sliderpro-lite-widget', 'Slider Pro', $widget_opts );
	}
 ...
 * @since 1.0.0
 */
function bqw_spl_register_widget() {
	register_widget( 'BQW_SliderPro_Lite_Widget' );
}