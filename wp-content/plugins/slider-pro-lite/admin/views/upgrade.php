<div class="wrap sliderpro-admin sliderpro-upgrade">
    ...
    <p><a href="http://codecanyon.net/item/slider-pro-responsive-wordpress-slider-plugin/253501?ref=bqworks">Buy the full version for only $29 &rarr;</a></p>
    ...
    <ul>
        ...
        <li>Thumbnails which can contain both text and images</li>
        <li>Retina support</li>
        <li>Lazy loading</li>
        <li>Deep linking</li>
        <li>Conditional images</li>
