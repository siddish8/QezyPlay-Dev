...
$pmproet_email_defaults = array(
	...
	'admin_change'             => array(
		'subject'     => __( "Your Subscription at !!sitename!! has been changed", 'pmproet' ),
		'description' => __( 'Admin Change', 'pmproet')
	),
	'admin_change_admin'       => array(
		'subject'     => __( "Subscription for !!user_login!! at !!sitename!! has been changed", 'pmproet' ),
	...
	'billing_failure'          => array(
		'subject'     => __( "Subscription Payment Failed at !!sitename!!", 'pmproet' ),
		'description' => __('Billing Failure', 'pmproet')
	),
	'billing_failure_admin'    => array(
		'subject'     => __( "Subscription Payment Failed For !!display_name!! at !!sitename!!", 'pmproet' ),
		'description' => __('Billing Failure (admin)', 'pmproet')
	),
	'cancel'                   => array(
		'subject'     => __( "Your Subscription at !!sitename!! has been CANCELLED", 'pmproet' ),
		'description' => __('Cancel', 'pmproet')
	),
	'cancel_admin'             => array(
		'subject'     => __( "Subscription for !!user_login!! at !!sitename!! has been CANCELLED", 'pmproet' ),
		'description' => __('Cancel (admin)', 'pmproet')
	),
	'checkout_check'           => array(
		'subject'     => __( "Your Subscription confirmation for !!sitename!!", 'pmproet' ),
	...
	'checkout_paid_admin'      => array(
		'subject'     => __( "Member Subscribed for !!membership_level_name!! at !!sitename!!", 'pmproet' ),
	...
	'invoice'                  => array(
		'subject'     => __( "INVOICE for !!sitename!! subscription", 'pmproet' ),
		'description' => __('Invoice', 'pmproet')
	),
	'membership_expired'       => array(
		'subject'     => __( "Your Subscription at !!sitename!! has ended", 'pmproet' ),
		'description' => __('Subscription Expired', 'pmproet')
	),
	'membership_expiring'      => array(
		'subject'     => __( "Your subscription at !!sitename!! will end soon", 'pmproet' ),
		'description' => __('Subscription Expiring', 'pmproet')
	),
	'trial_ending'             => array(
