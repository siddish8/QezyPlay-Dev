...
For a list of specific features, see the Ultimate Slider description page here: https://wordpress.org/plugins/ultimate-slider/.

For help and support, please see:

* Our FAQ page, here: https://wordpress.org/plugins/ultimate-slider/faq/
* Our documentation, here: http://www.etoilewebdesign.com/plugins/ultimate-slider/documentation-ultimate-slider/
* The Ultimate Slider support forum, here: https://wordpress.org/support/plugin/ultimate-slider
...
1. Front-end view of full-width slider
2. Slider with thumbnail previews
3. Slider with styled arrows
4. The lightbox slideshow mode
5. The 'Controls' options page, where you can set the arrows, colors and backgrounds
6. The slider options page
7. Individual slide options, showing choice of UPCP or WooCommerce integration
8. The admin table with list of slides
