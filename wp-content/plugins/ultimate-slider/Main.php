...
if (isset($_GET['post_type']) and $_GET['post_type'] == 'ultimate_slider' and isset($_POST['Upgrade_To_Full']) and $US_Full_Version == "Yes") {add_action("admin_notices", "EWD_US_Upgrade_Notice");}
