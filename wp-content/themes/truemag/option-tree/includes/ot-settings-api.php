          ...
          if ( ! isset( $page['hidden_page'] ) && $screen->id == $this->page_hook[$page['id']] ) {
            ...
            if ( $show_buttons ) {
              ...
              echo '<div id="option-tree-settings-api">';
				...
				echo '<span class="option-tree-ui-button button button-secondary right document"><a target="_blank" href="http://truemag.cactusthemes.com/document/">Documentation</a></span>';
				echo '<span class="option-tree-ui-button button button-secondary option-tree-ui-button grey right support"><a target="_blank" href="http://ticket.cactusthemes.com/">Support Forum</a></span>';
              ...
              if ( $show_buttons ) {
				...
				echo '<a href="' . str_replace( '&settings-updated=true', '', $_SERVER["REQUEST_URI"] ) .'&import_data=true" class="button red" style="left:30px;position: relative;top: -40px;height: 30px; padding-top: 1px" onclick="return confirm(\'This will import sample data. It may take a couple of minitues to finish. Are you sure?\');">' . __('Import Sample Data','') . '</a>';
