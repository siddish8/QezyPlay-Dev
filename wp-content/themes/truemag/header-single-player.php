...
?>
		<div id="media_cont" align="center" style="background-image:url(http://ideabytestraining.com/newqezyplay/wp-content/themes/truemag/images/wood-background.jpg)"><div id="player" <?php if($background_image_post){echo 'style="background-image:url('.$background_image_post[0].');  background-attachment:'.$ct_bg_attachment.';background-position:'.$ct_bg_position.'; background-repeat:'.$ct_bg_repeat.'"'; }?>>
        	<div class="container">
