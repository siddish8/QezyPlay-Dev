jQuery(document).ready(function(){
    var jsFolder = "http://ideabytestraining.com/newqezyplay/wp-content/uploads/amazingslider/1/sliderengine/";
    jQuery("#amazingslider-1").amazingslider({
        ...
        navbuttonradius:0,
        navthumbnavigationarrowimageheight:1,
        navmarginy:16,
        ...
        navthumbnavigationarrowimagewidth:1,
        ...
        transition:"slice,blocks,elastic,threed",
        scalemode:"fill",
        isfullscreen:false,
        textformat: {
